...
/// Environment field. Property value: prod/gray/pre/common/local.
...
typedef NS_ENUM(NSInteger, LogCacheDiscard)  {
    /// Default, if the number of log data exceeds the maximum value (5000), new data will not be written
    Discard,
    /// If the number of log data exceeds the maximum value, discard old data
    DiscardOldest
};
